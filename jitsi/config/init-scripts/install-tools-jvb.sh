#!/bin/bash
# Instalar herramientas de diagnóstico en contenedor jvb
# Este script se ejecuta automáticamente al iniciar el contenedor

echo "🔧 Instalando herramientas de diagnóstico en jvb..."
...
echo "❌ No se pudo instalar procps y net-tools en jvb"
exit 1
